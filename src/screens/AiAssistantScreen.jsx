...
const AiAssistantScreen = () => {
  ...
  const [messages, setMessages] = useState([
    {
      ...
      text: t(
        "ai.greeting",
        "Namaste! I am AgriSahayak. How can I help your farm today?",
      ),
      sender: "bot",
    },
  ]);
  ...
  const sendMessage = async (text = inputText, isSystemCmd = false) => {
    ...
    const newMsg = {
      ...
      text: isSystemCmd ? "📷 Image Uploaded" : text,
      sender: "user",
      image: isSystemCmd ? "leaf_mock" : null,
    };
  ...
  const handleCamera = () => {
    Alert.alert("Select Image", "Choose a photo of your crop to analyze.", [
    ...
    >
      {item.sender === "bot" && (
        <View style={styles.botIcon}>
          <Image
            source={require("../../assets/illustrations/mascot.jpg")}
      ...
      >
        ...
        <Text
          style={[
            styles.msgText,
            item.sender === "user" ? styles.textUser : styles.textBot,
          ]}
        >
          {item.text}
        </Text>
    ...
    >
      ...
      {(loading || statusText) && (
        <View style={styles.typingIndicator}>
          ...
          <Text style={styles.typingText}>
            {statusText || "AgriSahayak is thinking..."}
          </Text>
        </View>
      )}
      ...
      <View style={styles.inputArea}>
        <TouchableOpacity
          ...
          accessibilityLabel="Open camera to scan crop"
        >
